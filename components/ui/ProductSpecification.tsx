  ...
  return (
    <section className="bg-white  rounded-xl p-8 shadow-sm ">
      <div className="flex items-center gap-3 mb-6">
        <span className="material-symbols-outlined text-primary p-2 bg-primary/10 rounded-md">
          {/* tune */}
        </span>
        <h3 className="font-semibold text-xl  mb-4">Category Specifications</h3>
      </div>
      <div className="grid grid-cols-2 gap-6" id="tech-specs">
        <div className="flex flex-col gap-2">
          <label className="font-medium text-gray-5 ">RAM Capacity</label>
          <select className="w-full px-4 py-3 outline-none bg-gray-400/10 border-transparent rounded-md   focus:ring-0 transition-all font-body-md text-body-md">
            <option>4 GB</option>
            <option>8 GB</option>
            <option>16 GB</option>
            <option>32 GB</option>
        ...
        <div className="flex flex-col gap-2">
          ...
          <select className="w-full outline-none px-4 py-3  text-gray-500 bg-gray-400/10  border-transparent  rounded-md  tracking-wider font-medium focus:ring-0 transition-all font-body-md text-body-md">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input
            className="w-full px-4 py-3 bg-gray-400/10 border-transparent rounded-md   focus:ring-0 outline-none transition-all font-body-md text-body-md"
            placeholder="e.g. Apple M2 Max"
            type="text"
          />
        </div>
        <div className="flex flex-col gap-2">
          <label className="font-medium text-gray-5 ">Operating System</label>
          <input
            className="w-full px-4 py-3 bg-gray-400/10 border-transparent rounded-md  outline-none  transition-all font-body-md text-body-md"
